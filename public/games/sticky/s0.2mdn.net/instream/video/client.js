(function() {
    ...
    */
    ...
    p("WeakMap", function(a) {
        ...
        var h = 0,
            l = function(k) {
                ...
                if (k) {
                    var m = "undefined" != typeof Symbol && Symbol.iterator && k[Symbol.iterator];
                    for (k = m ? m.call(k) : {
                            next: aa(k)
                        }; !(m = k.next()).done;) m = m.value, this.set(m[0], m[1])
                }
            };
    ...
    var v = this || self,
        ...
        w = function(a, b, c) {
            w = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ?
                ja : ka;
    ...
    var va = Array.prototype.indexOf ? function(a, b) {
        ...
        function(a, b) {
            ...
            for (var c, d = a.length, e = [], f = 0, g = "string" === typeof a ? a.split("") : a, h = 0; h < d; h++)
                if (h in g) {
                    var l = g[h];
    ...
    var Qa = function(a) {
            return a instanceof H && a.constructor === H ? a.xa : "type_error:SafeUrl"
        },
        Ra = /^(?:audio\/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font\/\w+|image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video\/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\w+=(?:\w+|"[\w;,= ]+"))*$/i,
        Sa = /^data:(.*);base64,[a-z0-9+\/]+=*$/i,
        Ta = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
        Va = function(a) {
            if (!(a instanceof H))
                if (a = "object" == typeof a && a.V ? a.L() : String(a),
                    Ta.test(a)) a = new H(a, Pa);
                else {
                    a = String(a);
                    a = a.replace(/(%0A|%0D)/g, "");
                    var b = a.match(Sa);
    ...
    var Wa = {},
        Xa = new I("", Wa),
        Za = function(a) {
            if (a instanceof H) return a = Qa(a), 'url("' + a.replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") + '")';
            a = a instanceof Oa ? a instanceof Oa && a.constructor === Oa && a.Ja === Na ? a.Ga : "type_error:Const" : Ya(String(a));
            if (/[{;}]/.test(a)) throw new C("Value does not allow [{;}], got: %s.", [a]);
            return a
        },
        Ya = function(a) {
        ...
        bb = /^[-,."'%_!# a-zA-Z0-9\[\]]+$/,
        ab = /\b(url\([ \t\n]*)('[ -&(-\[\]-~]*'|"[ !#-\[\]-~]*"|[!#-&*-\[\]-~]*)([ \t\n]*\))/g,
        gb = "calc cubic-bezier fit-content hsl hsla linear-gradient matrix minmax repeat rgb rgba (rotate|scale|translate)(X|Y|Z|3d)?".split(" "),
        $a = new RegExp("\\b(" + gb.join("|") + ")\\([-+*/0-9a-z.%\\[\\], ]+\\)", "g"),
        cb = /\/\*/,
        eb = function(a) {
    ...
    var ib = function(a) {
        return a instanceof J && a.constructor === J ? a.va : "type_error:SafeStyleSheet"
    };
    ...
    var mb = function(a) {
            return a instanceof K && a.constructor === K ? a.ua : "type_error:SafeHtml"
        },
        lb = {},
    ...
    var ub = G("Opera"),
        L = G("Trident") || G("MSIE"),
        vb = G("Edge"),
        wb = G("Gecko") && !(Ha() && !G("Edge")) && !(G("Trident") || G("MSIE")) && !G("Edge"),
        xb = Ha() && !G("Edge"),
        yb = function() {
            var a = Ea;
    ...
    var Eb = Ab,
        ...
        Fb = function(a) {
            return tb(a, function() {
                ...
                var c = 0;
                b = E(String(b)).split(".");
                for (var d = E(String(a)).split("."), e = Math.max(b.length, d.length), f = 0; 0 == c && f < e; f++) {
                    var g = b[f] || "",
                        h = d[f] || "";
                    do {
                        g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
                        ...
                        c = Da(c, l) || Da(0 == g[2].length, 0 == h[2].length) || Da(g[2], h[2]);
                        g = g[3];
                        h = h[3]
                    } while (0 == c)
                }
    ...
    n.translate = function(a, b) {
        a instanceof Lb ? (this.x += a.x, this.y += a.y) : (this.x += Number(a), "number" === typeof b && (this.y += b));
        return this
    };
    ...
    var Pb = [],
        ...
        Rb = function(a) {
            if (Qb)
                for (var b = 0; b < Pb.length; b++) a(w(Pb[b].nb, Pb[b]))
        };
    var Sb = function() {};
    var Tb = function() {
    ...
    P.prototype.add = function(a, b, c, d, e) {
        ...
        var g = bc(a, b, d, e); - 1 < g ? (b = a[g], c || (b.ba = !1)) : (b = new $b(b, this.src, f, !!d, e), b.ba = c, a.push(b));
        return b
    };
    P.prototype.remove = function(a, b, c, d) {
        ...
        var e = this.g[a];
        b = bc(e, b, c, d);
        return -1 < b ? (c = e[b], ac(c), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.g[a], this.ma--), !0) : !1
    };
    var cc = function(a, b) {
        var c = b.type;
        if (c in a.g) {
    ...
    var dc = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Q = function(a, b, c, d, e) {
            ...
            else c = hc(c), a && a[Yb] ? (d = ia(d) ? !!d.capture : !!d, a.o.add(String(b), c, !1, d, e)) : ic(a, b, c, !1, d, e)
        },
        ic = function(a, b, c, d, e, f) {
            ...
            if (!c.ka) {
                ...
                d.src = a;
                d.listener = c;
                if (a.addEventListener) Tb || (e = g), void 0 === e && (e = !1),
        ...
        gc = function(a, b, c, d, e) {
            ...
            else c = hc(c), a && a[Yb] ? (d = ia(d) ? !!d.capture : !!d, a.o.add(String(b), c, !0, d, e)) : ic(a, b, c, !0, d, e)
        },
        oc = function(a,
            b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++) oc(a, b[f], c, d, e);
            else d = ia(d) ? !!d.capture : !!d, c = hc(c), a && a[Yb] ? a.o.remove(String(b), c, d, e) : a && (a = kc(a)) && (b = a.ra(b, c, d, e)) && pc(b)
        },
        pc = function(a) {
            if ("number" !== typeof a && a && !a.Y) {
                ...
                if (b && b[Yb]) cc(b.o, a);
                    ...
                    fc--;
                    (c = kc(b)) ? (cc(c, a), 0 == c.ma && (c.src = null, b[dc] = null)) :
                    ac(a)
                }
            }
        },
    ...
    R.prototype.dispatchEvent = function(a) {
        ...
        a.X || (g = a.currentTarget = c, e = sc(g, d, !0, a) && e, a.X || (e = sc(g, d, !1, a) && e));
        if (b)
            for (f = 0; !a.X && f < b.length; f++) g = a.currentTarget = b[f], e = sc(g, d, !1, a) && e;
        return c = e
    };
    ...
    var Cc = function(a, b, c) {
        ...
        d = "url(" < d ? -1 : "url(" == d ? 0 : 1;
        if (d = 0 == d) {
            if (!b.endsWith(")") || 1 < (b ? b.split("(").length - 1 : 0) || 1 < (b ? b.split(")").length - 1 : 0) || !c) return null;
            ...
            a = c ? (a = c(b, a)) && "about:invalid#zClosurez" != Qa(a) ? 'url("' + Qa(a).replace(zc, Bc) + '")' : null : null;
            return a
        }
        if (0 < b.indexOf("(")) {
    ...
    function Zc(a, b) {
        return W(Pc, a, a.getPropertyValue ? "getPropertyValue" : "getAttribute", [b]) || ""
    }

    function $c(a, b, c) {
        W(Qc, a, a.setProperty ? "setProperty" : "setAttribute", [b, c])
    };
    var ad = L && 10 > document.documentMode ? null : /\s*([^\s'",]+[^'",]*(('([^'\r\n\f\\]|\\[^])*')|("([^"\r\n\f\\]|\\[^])*")|[^'",])*)/g,
        bd = {
        ...
        ed = function(a, b, c) {
            ...
            D(a, function(e) {
                ...
                if (!(b && L && 10 == document.documentMode && /\\['"]/.test(e.selectorText))) {
                    var f = b ? e.selectorText.replace(ad, "#" + b + " $1") : e.selectorText,
                        g = d,
                        h = g.push;
                    e = dd(e.style,
                        c);
                    ...
                    var l = f.replace(/('|")((?!\1)[^\r\n\f\\]|\\[\s\S])*\1/g, "");
                    if (!/^[-_a-zA-Z0-9#.:* ,>+~[\]()=^$|]+$/.test(l)) throw Error("Selector allows only [-_a-zA-Z0-9#.:* ,>+~[\\]()=^$|] and strings, got: " + f);
                    a: {
                        for (var k = {
                                "(": ")",
                                "[": "]"
                    ...
                    if (!l) throw Error("() and [] in selector must be balanced, got: " +
                        f);
                    if (!(e instanceof I)) {
                        l = "";
                        for (t in e)
                            if (Object.prototype.hasOwnProperty.call(e, t)) {
                                ...
                                k = e[t];
                                null != k && (k = Array.isArray(k) ? xa(k, Za).join(" ") : Za(k), l += t + ":" + k + ";")
                            }
                        e = l ? new I(l, Wa) : Xa
                    }
                    var t = f + "{" + (e instanceof I && e.constructor === I ? e.wa : "type_error:SafeStyle").replace(/</g, "\\3C ") + "}";
                    t = new J(t, hb);
                    h.call(g, t)
                }
            });
        ...
        dd = function(a, b) {
            ...
            var c = document.createElement("div").style,
                d = hd(a);
            D(d, function(e) {
                var f = xb && e in bd ? e : e.replace(/^-(?:apple|css|epub|khtml|moz|mso?|o|rim|wap|webkit|xv)-(?=[a-z])/i,
                    "");
                0 != f.lastIndexOf("--", 0) && 0 != f.lastIndexOf("var", 0) && (e = Zc(a, e), e = Cc(f, e, b), null != e && $c(c, f, e))
            });
        ...
        jd = function(a) {
            ...
            c.sort(function(e, f) {
                ...
                a: {
                    f = e;e = g;
                    var h = h || Ba;g = Math.min(f.length, e.length);
                    for (var l = 0; l < g; l++) {
                        var k = h(f[l], e[l]);
                        if (0 != k) {
                            f = k;
            ...
            for (var d; d = a.nextNode();) D(c, function(e) {
                W(Jc, d, d.matches ? "matches" : "msMatchesSelector", [e.selectorText]) && e.style && id(d, e.style)
            });
            D(b, Nb)
        },
        id = function(a, b) {
        ...
        hd = function(a) {
            ...
            (b = "array" == b || "object" == b && "number" == typeof a.length) ? a = Aa(a): (a = oa(a), ya(a, "cssText"));
            return a
        };
    var kd = "undefined" != typeof WeakMap && -1 != WeakMap.toString().indexOf("[native code]"),
        ld = 0,
        md = function() {
            this.ta = [];
            this.na = [];
    ...
    md.prototype.set = function(a, b) {
        if (W(Ec, a, "hasAttribute", [this.J])) {
            ...
            this.na[c] = b
        } else c = this.na.push(b) - 1, Tc(a, this.J, c.toString()), this.ta.push(a);
        return this
    };
    md.prototype.get = function(a) {
        if (W(Ec, a, "hasAttribute", [this.J])) return a = parseInt(W(Fc, a, "getAttribute", [this.J]) || null, 10), this.na[a]
    };
    ...
    var td = {
        ...
        xd = function(a) {
            ...
            this.za = a.za;
            D(a.Oa, function(b) {
                if (0 != b.lastIndexOf("data-", 0)) throw new C('Only "data-" attributes allowed, got: %s.', [b]);
                if (0 == b.lastIndexOf("data-sanitizer-", 0)) throw new C('Attributes with "%s" prefix are not allowed, got: %s.', ["data-sanitizer-", b]);
                this.R["* " +
                    b.toUpperCase()] = wd
            }, this);
            D(a.Na, function(b) {
                b = b.toUpperCase();
                if (-1 == b.indexOf("-") || td[b]) throw new C("Only valid custom element tag names allowed, got: %s.", [b]);
                this.N[b] = !0
            }, this);
            this.ia = a.ia;
            this.Z = a.Z;
    ...
    var yd = function(a) {
            return function(b, c) {
                b = E(b);
                return (c = a(b, c)) && "about:invalid#zClosurez" != Qa(c) ? Qa(c) : null
            }
        },
        ud = function() {
            this.i = {};
        ...
        vd = function(a) {
            if (a.Ea) throw Error("HtmlSanitizer.Builder.build() can only be used once.");
            X(a.i, a.j, "* USEMAP", Ad);
    ...
    xd.prototype.createTextNode = function(a) {
        var b = a.data;
        (a = Yc(a)) && "style" == Wc(a).toLowerCase() && !("STYLE" in this.$) && "STYLE" in this.N && (b = ib(gd(b, this.ca, w(function(c, d) {
            return this.ia(c, {
                kb: d
            })
        }, this))));
    ...
    v.console && "function" === typeof v.console.log && w(v.console.log, v.console);
    var Id = function() {
        if (!e) return this;
        var a = e.lb(),
            b = e.mb(),
    ...
    var Jd = null,
        Kd = function() {
            ...
            if (a.body) a.body.appendChild(b);
                ...
                d = d && e ? "sanitizer-" + (Math.floor(2147483648 * Math.random()).toString(36) + Math.abs(Math.floor(2147483648 *
                    Math.random()) ^ Date.now()).toString(36)) : b.Z;
                b.ca = d;
                if (od) {
                    d = c;
                    if (od) {
                        c = Mb("SPAN");
                        b.ca && "*" == b.Z && (c.id = b.ca);
                        b.sa && (d = fd("<div>" + d + "</div>"), jd(d), d = d.innerHTML);
                        d = ob(d);
                        ...
                        d = document.createTreeWalker(e, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_TEXT, null, !1);
                        for (e = kd ? new WeakMap : new md; f = d.nextNode();) {
                                    ...
                                    case 1:
                                        ...
                                        if ("TEMPLATE" == Wc(l).toUpperCase()) h = null;
                                            ...
                                            if (k in h.$) h = null;
                                                ...
                                                var m = "SPAN";
                                                m = Mb(m);
                                                h.za && Tc(m, "data-sanitizer-original-tag", k.toLowerCase());
                                                h = m
                                            }
                                            if (h) {
                                                k = l;
                                                ...
                                                if (null != r)
                                                    for (var F = 0; l = r[F]; F++)
                                                        if (l.specified) {
                                                            ...
                                                            var pa = l,
                                                                V = pa.name;
                                                            if (0 == V.lastIndexOf("data-sanitizer-", 0)) q = null;
                                                            else {
                                                                var qa = Wc(t);
                                                                pa = pa.value;
                                                                var fb = {
                                                                ...
                                                                t = jc;
                                                                qa = Fd(qa, V);
                                                                qa in q.R ? (q = q.R[qa], q = q(pa, fb, t)) : (V = Fd(null, V), V in q.R ? (q = q.R[V], q = q(pa, fb, t)) : q = null)
                                                            }
                            ...
                            if (h) {
                                if (1 == Xc(h) && e.set(f, h), f = Yc(f), g = !1, f) l = Xc(f), k = Wc(f).toLowerCase(), m = Yc(f), 11 != l || m ? "body" == k && m && (l = Yc(m)) && !Yc(l) && (g = !0) : g = !0, l = null, g || !f ? l = c : 1 == Xc(f) && (l = e.get(f)), l.content && (l = l.content), l.appendChild(h)
                            } else
                                for (h = f; f = h.firstChild;) h.removeChild(f)
                        }
                        e.clear && e.clear();
                        b = c
                    } else b = Mb("SPAN");
    ...
    Sd.prototype.remove = function() {
        var a = null;
        this.O && (a = this.O, this.O = this.O.next, this.O || (this.oa = null), a.next = null);
        return a
    };
    var Td = new Nd(function() {
            return new Ud
        }, function(a) {
            return a.reset()
        }),
    ...
    var Zd = function(a, b) {
        ...
        Vd, Wd = function() {
            if (v.Promise && v.Promise.resolve) {
                ...
                c && (e = w(b, c));
                e = Qd(e);
                "function" !== typeof v.setImmediate || !d && v.Window && v.Window.prototype && !G("Edge") && v.Window.prototype.setImmediate == v.setImmediate ? (Od || (Od = Pd()), Od(e)) : v.setImmediate(e)
            }
        },
        Xd = !1,
        Yd = new Sd,
    ...
    Z.prototype.then = function(a, b, c) {
        return ee(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
    var fe = Z;
    ...
    var he = function(a, b) {
            if (0 == a.h)
                if (a.F) {
                    var c = a.F;
                    if (c.l) {
                        for (var d = 0, e = null, f = null, g = c.l; g && (g.aa || (d++, g.C == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g);
                        e && (0 == c.h && 1 == d ? he(c, b) : (f ? (d = f, d.next == c.H && (c.H = d), d.next = d.next.next) : ie(c), je(c, e, 3, b)))
                    }
                    a.F = null
                } else ae(a, 3, b)
        },
    ...
    var ae = function(a, b, c) {
            if (0 == a.h) {
                ...
                h || (a.Fa = c, a.h = b, a.F = null, ke(a), 3 != b || c instanceof ge || ne(a, c))
            }
        },
    ...
    var se = function() {
            ...
            try {
                if ("1" == f) {
                    for (var g = a.parent; g != a.top; g = g.parent) re(this, g, g.document);
    ...
    n.ya = function() {
        ...
        null != this.D && -1 < this.D ? a.push("la" + 1E3 * (Y() - this.D)) : a.push("la-1");
        return a.join("_")
    };
    n.Ca = function() {
        return Y() - this.G
    ...
    Md();
    window.ima && window.ima.video && window.ima.video.client && window.ima.video.client.tagged || (ve(), x("ima.video.client.getEData", function() {
        return new y
    }), x("ima.video.client.setupEDHooks", ve), x("ima.video.client.resetEDForTesting", we), x("ima.video.client.tagged", !0));
}).call(this);