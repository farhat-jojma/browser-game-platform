      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-4 md:mt-0 flex items-center justify-center md:justify-end">
            ...
            <div className="ml-6 pl-6 border-l-2 border-foreground/30 flex items-center space-x-4">
              {/* <a aria-label="Twitter" href="#" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
              ...
              {/* <a aria-label="Instagram" href="https://www.instagram.com/gamesonlinegratis/" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              {/* <a aria-label="Facebook" href="#" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                  <path d="M13.5 9H16l.5-3h-3V4.5c0-.866.176-1.2 1.4-1.2H16V0h-2.1C10.9 0 10 1.343 10 4.1V6H8v3h2v9h3.5V9Z"/>
                </svg>
              </a> */}
              <a aria-label="GitHub" href="https://github.com/farhat-jojma/browser-game-platform" className="text-muted-foreground hover:text-foreground transition-colors duration-200" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
