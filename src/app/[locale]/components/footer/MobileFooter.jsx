        ...
        <div className="text-center space-y-3">
         ...
         {/* Divider */}
          ...
          <div className="mt-1 flex items-center justify-center space-x-4 text-muted-foreground/70">
            ...
            {/* <a aria-label="Instagram" href="https://www.instagram.com/gamesonlinegratis/" className="hover:text-foreground transition-colors duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
            ...
            <a aria-label="GitHub" href="https://github.com/farhat-jojma/browser-game-platform" className="hover:text-foreground transition-colors duration-200" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
