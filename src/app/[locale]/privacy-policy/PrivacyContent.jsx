// PrivacyContent.jsx (client)
"use client";
import { useEffect, useState } from "react";

export default function PrivacyContent({ locale, fallbackIntro, section1, section2 }) {
  ...
  return (
    <>
      <p>{fallbackIntro}</p>
      <h2 className="text-xl font-bold mt-6">{section1.title}</h2>
      <p>{section1.content}</p>
      <h2 className="text-xl font-bold mt-6">{section2.title}</h2>
