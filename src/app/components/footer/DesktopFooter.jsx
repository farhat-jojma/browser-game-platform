        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-xs text-muted-foreground/80 mt-1">
              Bringing you the best browser games since 2024
            </p>
          </div>
          ...
          <div className="mt-4 md:mt-0 flex items-center justify-center md:justify-end">
            ...
            <div className="ml-6 pl-6 border-l-2 border-foreground/30 flex items-center space-x-4">
              ...
              <a aria-label="Instagram" href="#" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              <a aria-label="GitHub" href="#" className="text-muted-foreground hover:text-foreground transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
